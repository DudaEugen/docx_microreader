...
from properties import XMLementPropertyDescriptions as PDs


class Paragraph(XMLement):
    tag: str = 'w:p'
    _properties_unificators = {
        PDs.Par_align: [('left', ['start']),
                        ('right', ['end']),
                        ('center', []),
                        ('both', []),
                        ('distribute', [])]
    ...
    def get_align(self) -> Property:
        return self._properties[PDs.Par_align]

    def set_align_value(self, align: Union[str, None]):
        """
        :param align: 'both' or 'right' or 'center' or 'left
        """
        self._properties[PDs.Par_align].value = align

    def get_indent_left(self) -> Property:
        return self._properties[PDs.Par_indent_left]

    def set_indent_left_value(self, indent_left: Union[str, None]):
        self._properties[PDs.Par_indent_left].value = indent_left

    def get_indent_right(self) -> Property:
        return self._properties[PDs.Par_indent_right]

    def set_indent_right_value(self, indent_right: Union[str, None]):
        self._properties[PDs.Par_indent_right].value = indent_right

    def get_hanging(self) -> Property:
        return self._properties[PDs.Par_hanging]

    def set_hanging_value(self, hanging: Union[str, None]):
        self._properties[PDs.Par_hanging].value = hanging

    def get_first_line(self) -> Property:
        return self._properties[PDs.Par_first_line]

    def set_first_line_value(self, first_line: Union[str, None]):
        self._properties[PDs.Par_first_line].value = first_line

    def is_keep_lines(self) -> bool:
        return self._properties[PDs.Par_keep_lines].value

    def set_as_keep_lines(self, is_keep_lines: bool = True):
        self._properties[PDs.Par_keep_lines].value = is_keep_lines

    def is_keep_next(self) -> bool:
        return self._properties[PDs.Par_keep_next].value

    def set_as_keep_next(self, is_keep_next: bool = True):
        self._properties[PDs.Par_keep_next].value = is_keep_next

    def get_outline_level(self) -> Property:
        return self._properties[PDs.Par_outline_level]

    def set_outline_level_value(self, level: Union[str, int, None]):
        """
        :param level: 0-9
        """
        self._properties[PDs.Par_outline_level].value = level
    ...
    def get_border(self, direction: str, property_name: str) -> Property:
        ...
        """
        return self._properties[rf'{PDs.Const_prefixes["border"]}' \
                                rf'{PDs.Const_directions[direction]}{PDs.Const_property_names[property_name]}']
    ...
    def set_border_value(self, direction: str, property_name: str, value: Union[str, None]):
        ...
        """
        self._properties[
            rf'{PDs.Const_prefixes["border"]}{PDs.Const_directions[direction]}{PDs.Const_property_names[property_name]}'
        ].value = value
    ...
    class Run(XMLement):
        ...
        def get_size(self) -> Property:
            return self._properties[PDs.Run_size]

        def set_size_value(self, value: Union[str, None]):
            self._properties[PDs.Run_size].value = value

        def is_bold(self) -> bool:
            return self._properties[PDs.Run_is_bold].value

        def set_as_bold(self, is_bold: bool = True):
            self._properties[PDs.Run_is_bold].value = is_bold

        def is_italic(self) -> bool:
            return self._properties[PDs.Run_is_italic].value

        def set_as_italic(self, is_italic: bool = True):
            self._properties[PDs.Run_is_italic].value = is_italic

        def is_strike(self) -> bool:
            return self._properties[PDs.Run_is_strike].value

        def set_as_strike(self, is_strike: bool = True):
            self._properties[PDs.Run_is_strike].value = is_strike

        def get_language(self) -> Property:
            return self._properties[PDs.Run_language]

        def set_language_value(self, value: Union[str, None]):
            self._properties[PDs.Run_language].value = value

        def get_vertical_align(self) -> Property:
            return self._properties[PDs.Run_vertical_align]

        def set_vertical_align_value(self, value: Union[str, None]):
            """
            param value: 'superscript' or 'subscript'
            """
            self._properties[PDs.Run_vertical_align].value = value

        def get_color(self) -> Property:
            return self._properties[PDs.Run_color]

        def set_color_value(self, value: Union[str, None]):
            """
            param value: specifies the color as a hex value in RRGGBB format or auto
            """
            self._properties[PDs.Run_color].value = value

        def get_theme_color(self) -> Property:
            return self._properties[PDs.Run_theme_color]

        def set_theme_color_value(self, value: Union[str, None]):
            self._properties[PDs.Run_theme_color].value = value

        def get_background_color(self) -> Property:
            return self._properties[PDs.Run_background_color]
        ...
        def set_background_color_value(self, value: Union[str, None]):
            ...
            """
            self._properties[PDs.Run_background_color].value = value

        def get_background_fill(self) -> Property:
            return self._properties[PDs.Run_background_fill]

        def set_background_fill_value(self, value: Union[str, None]):
            """
            param value: specifies the color as a hex value in RRGGBB format or auto
            """
            self._properties[PDs.Run_background_fill].value = value

        def get_underline(self) -> Property:
            return self._properties[PDs.Run_underline]

        def set_underline_value(self, value: Union[str, None]):
            self._properties[PDs.Run_underline].value = value

        def get_underline_color(self) -> Property:
            return self._properties[PDs.Run_underline_color]

        def set_underline_color_value(self, value: Union[str, None]):
            """
            param value: specifies the color as a hex value in RRGGBB format or auto
            """
            self._properties[PDs.Run_underline_color].value = value
        ...
        def get_border(self, property_name: str) -> Property:
            ...
            """
            return self._properties[rf'border{PDs.Const_property_names[property_name]}']
        ...
        def set_border_value(self, property_name: str, value: Union[str, None]):
            ...
            (keys of XMLementPropertyDescriptions.Const_property_names dict)
            """
            self._properties[rf'border{PDs.Const_property_names[property_name]}'].value = value
...
class Table(XMLement):
    ...
    def __calculate_rowspan_for_cells(self):
        ...
        for row in self.rows:
            ...
            for i in range(len(row.cells)):
                ...
                j += col_span_number
                if row.cells[i].get_property_value(PDs.Cell_vertical_merge) == 'restart':
                    cells[j] = row.cells[i]
                    cells[j].row_span = 1
                elif row.cells[i].get_property_value(PDs.Cell_vertical_merge) == 'continue':
                    cells[j].row_span += 1
                ...
                for row in self.rows:
                    for cell in row.cells:
                        if cell.get_property_value(rf'{PDs.Const_prefixes["margin"]}' \
                                    rf'{PDs.Const_directions[direction]}{PDs.Const_property_names["size"]}') is None:
                            cell.set_property_value(rf'{PDs.Const_prefixes["margin"]}' \
                                    rf'{PDs.Const_directions[direction]}{PDs.Const_property_names["size"]}',
                                                    self._properties[rf'{PDs.Const_prefixes["cell_margin"]}' \
                                                                     rf'{PDs.Const_directions[direction]}' \
                                                                     rf'{PDs.Const_property_names["size"]}'].value)
                            cell.set_property_value(rf'{PDs.Const_prefixes["margin"]}' \
                                    rf'{PDs.Const_directions[direction]}{PDs.Const_property_names["type"]}',
                                                    self._properties[rf'{PDs.Const_prefixes["cell_margin"]}' \
                                                                     rf'{PDs.Const_directions[direction]}' \
                    ...
                    for j in range(len(self.rows[i].cells)):
                        if not (i == 0 and direction == 'top') and \
                            ...
                            if self.rows[i].cells[j].get_property_value(rf'{PDs.Const_prefixes["border"]}' \
                                    rf'{PDs.Const_directions[direction]}{PDs.Const_property_names["color"]}') is None or \
                                    self.rows[i].cells[j].get_property_value(rf'{PDs.Const_prefixes["border"]}' \
                                    rf'{PDs.Const_directions[direction]}{PDs.Const_property_names["color"]}') == 'auto':
                                self.rows[i].cells[j].set_property_value(
                                    rf'{PDs.Const_prefixes["border"]}' \
                                    rf'{PDs.Const_directions[direction]}{PDs.Const_property_names["color"]}',
                                    self._properties[rf'{PDs.Const_prefixes["borders_inside"]}' \
                            ...
                            if self.rows[i].cells[j].get_property_value(rf'{PDs.Const_prefixes["border"]}' \
                                ...
                                self.rows[i].cells[j].set_property_value(
                                    ...
                                    self._properties[rf'{PDs.Const_prefixes["borders_inside"]}' \
                                                     rf'_{d}{PDs.Const_property_names["size"]}'].value
                                )
    ...
    def get_width(self) -> Tuple[Property, Property, Property]:
        ...
        """
        return self._properties[PDs.Tab_width], self._properties[PDs.Tab_width_type], self._properties[PDs.Tab_layout]

    def set_width_value(self, width: Union[str, None], width_type: Union[str, None], layout: str = 'autofit'):
        self._properties[PDs.Tab_width].value = width
        self._properties[PDs.Tab_width_type].value = width_type
        self._properties[PDs.Tab_layout].value = layout

    def get_align(self) -> Property:
        return self._properties[PDs.Tab_align]

    def set_align_value(self, value: Union[str, None]):
        self._properties[PDs.Tab_align].value = value
    ...
    def set_border_value(self, direction: str, property_name: str, value: Union[str, None]):
        ...
        :param property_name: color, size, type         (keys of XMLementPropertyDescriptions.Const_property_names dict)
        """
        self._properties[rf'{PDs.Const_prefixes["border"]}{PDs.Const_directions[direction]}' \
                         rf'{PDs.Const_property_names[property_name]}'].value = value

    def get_indentation(self) -> Tuple[Property, Property]:
        """
        return: Tuple(value, type)
        """
        return self._properties[PDs.Tab_indentation], self._properties[PDs.Tab_indentation_type]

    def set_indentation_value(self, width: Union[str, None], width_type: Union[str, None]):
        self._properties[PDs.Tab_indentation].value = width
        self._properties[PDs.Tab_indentation_type].value = width_type
    ...
    def get_inside_border(self, direction: str, property_name: str) -> Property:
        ...
        :param property_name: 'color', 'size', 'type'  (keys of XMLementPropertyDescriptions.Const_property_names dict)
        """
        return self._properties[rf'{PDs.Const_prefixes["borders_inside"]}' \
                                rf'_{direction}{PDs.Const_property_names[property_name]}']
    ...
    def set_inside_border_value(self, direction: str, property_name: str, value: Union[str, None]):
        ...
        """
        self._properties[rf'{PDs.Const_prefixes["borders_inside"]}' \
                        rf'_{direction}{PDs.Const_property_names[property_name]}'].value = value
    ...
    def get_cells_margin(self, direction: str) -> Tuple[Property, Property]:
        ...
        """
        return self._properties[rf'{PDs.Const_prefixes["cell_margin"]}{PDs.Const_directions[direction]}' \
                                rf'{PDs.Const_property_names["size"]}'], \
               self._properties[rf'{PDs.Const_prefixes["cell_margin"]}{PDs.Const_directions[direction]}' \
                                rf'{PDs.Const_property_names["type"]}']
    ...
    def set_cells_margin_value(self, direction: str, value: Union[str, None], value_type: Union[str, None] = 'dxa'):
        ...
        """
        self._properties[rf'{PDs.Const_prefixes["cell_margin"]}{PDs.Const_directions[direction]}' \
                         rf'{PDs.Const_property_names["size"]}'].value = value
        self._properties[rf'{PDs.Const_prefixes["cell_margin"]}{PDs.Const_directions[direction]}' \
                         rf'{PDs.Const_property_names["type"]}'].value = value_type
    ...
    class Row(XMLement):
        ...
        def __init__(self, element: ET.Element, parent):
            ...
            if self._properties[PDs.Row_is_header].value:
        ...
        def is_header(self) -> bool:
            return self._properties[PDs.Row_is_header].value

        def set_as_header(self, is_header: bool = True):
            self._properties[PDs.Row_is_header].value = is_header
            self.__set_cells_as_header()
        ...
        def get_height(self) -> Tuple[Property, Property]:
            ...
            """
            return self._properties[PDs.Row_height], self._properties[PDs.Row_height_rule]

        def set_height_value(self, value: Union[str, None], height_rule: str = 'atLeast'):
            self._properties[PDs.Row_height].value = value
            self._properties[PDs.Row_height_rule].value = height_rule
        ...
        class Cell(XMLcontainer):
            ...
            def get_fill_color(self) -> Property:
                return self._properties[PDs.Cell_fill_color]

            def set_fill_color_value(self, value: Union[str, None]):
                self._properties[PDs.Cell_fill_color].value = value

            def get_fill_theme(self) -> Property:
                return self._properties[PDs.Cell_fill_theme]

            def set_fill_theme_value(self, value: Union[str, None]):
                self._properties[PDs.Cell_fill_theme].value = value
            ...
            def get_border(self, direction: str, property_name: str) -> Property:
                ...
                :param property_name: color, size, type (keys of XMLementPropertyDescriptions.Const_property_names dict)
                """
                return self._properties[rf'{PDs.Const_prefixes["border"]}{PDs.Const_directions[direction]}' \
                                        rf'{PDs.Const_property_names[property_name]}']
            ...
            def get_width(self) -> Tuple[Property, Property]:
                ...
                """
                return self._properties[PDs.Cell_width], self._properties[PDs.Cell_width_type]

            def set_width_value(self, width: Union[str, None], width_type: Union[str, None]):
                self._properties[PDs.Cell_width].value = width
                self._properties[PDs.Cell_width_type].value = width_type

            def get_col_span(self) -> Property:
                return self._properties[PDs.Cell_col_span]

            def set_col_span_value(self, value: int):
                self._properties[PDs.Cell_col_span].value = value

            def get_vertical_align(self) -> Property:
                return self._properties[PDs.Cell_vertical_align]

            def set_vertical_align_value(self, value: str):
                self._properties[PDs.Cell_vertical_align].value = value

            def get_text_direction(self) -> Property:
                return self._properties[PDs.Cell_text_direction]

            def set_text_direction_value(self, value: Union[str, None]):
                self._properties[PDs.Cell_text_direction].value = value
            ...
            def get_margin(self, direction: str) -> Tuple[Property, Property]:
                ...
                :return: (margin, type)
                """
                return self._properties[rf'{PDs.Const_prefixes["margin"]}' \
                                        rf'{PDs.Const_directions[direction]}{PDs.Const_property_names["size"]}'], \
                       self._properties[rf'{PDs.Const_prefixes["margin"]}' \
                                        rf'{PDs.Const_directions[direction]}{PDs.Const_property_names["type"]}']
            ...
            def set_margin_value(self, direction: str, value: Union[str, None], value_type: Union[str, None] = 'dxa'):
                ...
                """
                self._properties[rf'{PDs.Const_prefixes["margin"]}' \
                            rf'{PDs.Const_directions[direction]}{PDs.Const_property_names["size"]}'].value = value
                self._properties[rf'{PDs.Const_prefixes["margin"]}' \
                            rf'{PDs.Const_directions[direction]}{PDs.Const_property_names["type"]}'].value = value_type
