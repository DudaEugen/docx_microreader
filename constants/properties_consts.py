...
table_style_property_descriptions: Dict[str, PropertyDescription] = {
    ...
    Tab_borders_inside_horizontal: PropertyDescription('w:tblPr/w:tblBorders', 'w:insideH', 'w:val'),
    Tab_borders_inside_horizontal_color: PropertyDescription('w:tblPr/w:tblBorders', 'w:insideH', 'w:color'),
    Tab_borders_inside_horizontal_size: PropertyDescription('w:tblPr/w:tblBorders', 'w:insideH', 'w:sz'),
    Tab_borders_inside_vertical: PropertyDescription('w:tblPr/w:tblBorders', 'w:insideV', 'w:val'),
    Tab_borders_inside_vertical_color: PropertyDescription('w:tblPr/w:tblBorders', 'w:insideV', 'w:color'),
    Tab_borders_inside_vertical_size: PropertyDescription('w:tblPr/w:tblBorders', 'w:insideV', 'w:sz'),
